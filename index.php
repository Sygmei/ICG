          ...
          <div class="col-md-3 offset-md-8 col-xs-4 offset-xs-6">
            ...
            <div class="inputBox">
              <form id="pas-de-box" action="php/verificationBox.php" method="post">
                <span>
                  <input class="gate" id="box" type="text" name="box" placeholder="Saississez votre N° de Box ou Pass" onkeyup='this.value=this.value.toUpperCase()' /><label for="box">N° Box ou pass<i data-toggle="tooltip" data-placement="right" data-html="true" title="<img src='/images/box.png' alt='box'>">?</i></label>
                </span>
